...
<template>
    <div class="flex flex-col items-center">
        ...
        <span class="text-sm text-gray-700 dark:text-gray-400">
            Mostrando del registro <span class="font-semibold text-gray-900 dark:text-white">{{ props.meta.from }}</span> al <span
                class="font-semibold text-gray-900 dark:text-white">{{ props.meta.to }}</span> de <span
                class="font-semibold text-gray-900 dark:text-white">{{ props.meta.total }}</span>
        </span>
        <!-- Buttons -->
        <div class="inline-flex mt-2 xs:mt-0">
            <a :href="props.links.prev"
