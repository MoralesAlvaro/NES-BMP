...
<template>
    <form @submit.prevent="submit" class="py-8 px-5 flex-auto">
        <IsLoanding :isLoading="isLoading"> </IsLoanding>
        <h2 class="font-semibold md:text-2xl text-lg text-dark-blue-500 leading-tight text-center">¿Deseas eliminar a este
            usuario?</h2>
        <div class="px-5">
